...
var x__25440__auto__ = (((x == null))?null:x);
var m__25441__auto__ = (sablono.util.to_str[goog.typeOf(x__25440__auto__)]);
if(!((m__25441__auto__ == null))){
return m__25441__auto__.call(null,x);
} else {
var m__25441__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__25441__auto____$1 == null))){
return m__25441__auto____$1.call(null,x);
} else {
...
var x__25440__auto__ = (((x == null))?null:x);
var m__25441__auto__ = (sablono.util.to_uri[goog.typeOf(x__25440__auto__)]);
if(!((m__25441__auto__ == null))){
return m__25441__auto__.call(null,x);
} else {
var m__25441__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__25441__auto____$1 == null))){
return m__25441__auto____$1.call(null,x);
} else {
...
var len__25852__auto___26080 = arguments.length;
var i__25853__auto___26081 = (0);
while(true){
if((i__25853__auto___26081 < len__25852__auto___26080)){
args__25859__auto__.push((arguments[i__25853__auto___26081]));

var G__26082 = (i__25853__auto___26081 + (1));
i__25853__auto___26081 = G__26082;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__25860__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq26079){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq26079));
});
...
var vec__26086 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__26088;
var words = seq__26087__$1;
...
var G__26090 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__26090,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__26090;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__26091_SHARP_){
if(typeof p1__26091_SHARP_ === 'string'){
return p1__26091_SHARP_;
} else {
return cljs.core.seq.call(null,p1__26091_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__24777__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1482247104324