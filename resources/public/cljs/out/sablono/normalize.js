...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__26094_SHARP_){
return ((p1__26094_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__26094_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.call(null,G__26096,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__26096;
}
});
...
var len__25852__auto___26099 = arguments.length;
var i__25853__auto___26100 = (0);
while(true){
if((i__25853__auto___26100 < len__25852__auto___26099)){
args__25859__auto__.push((arguments[i__25853__auto___26100]));

var G__26101 = (i__25853__auto___26100 + (1));
i__25853__auto___26100 = G__26101;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__25860__auto__);
});
...
var G__26098 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__26098,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__26098;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq26097){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq26097));
});
...
var vec__26107 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__26107,(0),null);
var names = cljs.core.nth.call(null,vec__26107,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__26107,tag_name,names){
return (function (p1__26102_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__26102_SHARP_));
});})(matches,vec__26107,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__26107,tag_name,names){
return (function (p1__26103_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__26103_SHARP_));
});})(matches,vec__26107,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__26110){
...
var tag = first__26119;
var content = seq__26118__$1;
...
var vec__26120 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__26120,(0),null);
var id = cljs.core.nth.call(null,vec__26120,(1),null);
var class$ = cljs.core.nth.call(null,vec__26120,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1482247104394